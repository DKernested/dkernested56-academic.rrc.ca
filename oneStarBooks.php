...
<?php
    ...
    $query = "SELECT * FROM books WHERE AverageRating > 0.5 AND AverageRating < 1.5 ORDER BY Title ASC";
...
<ul>
<li><a href="fiveStarBooks.php">Five Star Books</a></li>
<li><a href="fourStarBooks.php">Four Star Books</a></li>
<li><a href="threeStarBooks.php">Three Star Books</a></li>
<li><a href="twoStarBooks.php">Two Star Books</a></li>
<li><a href="oneStarBooks.php">One Star Books</a></li>
</ul>
